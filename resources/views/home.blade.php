    ...
    <body class="flex justify-center">
        ...
        <nav class="fixed top-0 left-0 w-full bg-white shadow z-50 h-16 flex items-center px-8">
            <div class="flex-1 flex items-center">
                <span class="text-2xl font-bold text-red-700 tracking-wide">OSOlink Solutions</span>
            </div>
            <div class="flex items-center space-x-4">
                <span class="text-gray-700 font-medium whitespace-nowrap">Welcome, {{ auth()->user()->name }}!</span>
                <form action="/logout" method="POST">
                    @csrf
                    <button type="submit" class="bg-red-600 text-white px-4 py-2 mt-4 rounded hover:bg-red-700 transition font-semibold">
                        Logout
                    </button>
                </form>
            </div>
        ...
        <div class="p-10 w-full pt-24">
            <div class="flex justify-between items-center mb-6 w-full">
                <h2 class="text-2xl font-bold text-red-700 text-left">Task Management System</h2>
            ...
            <ul>
                <li class="p-4 bg-gray-300 rounded shadow md:flex-row md:items-center justify-between gap-4">
            ...
            {{-- Add Task Modal --}}
            <div id="addTaskModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
            ...
            {{-- Edit Task Modal --}}
            <div id="editTaskModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
                <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-md">
        ...
        <div class="w-full max-w-sm p-8 rounded-2xl shadow-2xl flex flex-col items-center bg-gradient-to-b from-red-600 to-red-400 border-2 border-red-700 my-24">
